  ...
  return (
    ...
    <Layout>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Button variant="primary" type="button"  onClick={() => history.push("/home/adminHome")} style={{width:"100%"}}>
              Login
            </Button>
            
            <span>
                Or <Link to="/issueUserID" style={{color:"#16c79a"}}>issue your user ID now!</Link>
            </span>
